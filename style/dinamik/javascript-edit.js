...
//////////////////////////////////////////////////////////////////////////////////////////////////////////  
           ...
           function hesapla_yaz(pos){// sayfanın genişlik ve yüksekliğini yazar
           ...
           // sayfayı yeniden boyutlandırır
           function sayfa_boyutlandır(){
               var pos = $( "#sayfa" ),
                    widthVal = parseFloat($("#width").val()),
                    heightVal = parseFloat($("#height").val());
           ...
           $( '#kayitli_dizayn' ).on('change',function(){
                    window.location = "dizayn-edit.php?id=" + $(this).val();
           });
