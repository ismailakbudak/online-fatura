<html>
  ...
  <body>
    <div class="my" style=" float:left; font-size: 16px; text-align:center;" ></div>   
    <?php
        error_reporting(0);
        ...
        require_once  "captcha/create_captcha.php";
        // captcha session'nına değerler atanıyor
        $_SESSION['captcha'] = captcha();  // print_r($_SESSION['captcha']);
   ...
   <div class="wrap">
	  <div id="content">
		  <div id="main">
			 <div class="full_w">
			    <div style="padding-left: 15px; padding-top: 15px; text-align: center; color: #C66653"> Kullanıcı Panel Girişi </div> 
			    <div class="sep"></div>
