...
<script type="text/javascript">
   ...
   function ajax() {
        ...
        $.ajax({
            url: "../radio-checkbox.php?page=ekle-form-fatura2",
   ...
   $(function() {
    ...
    var dizi = new Array('fatura_no','musteri_fk','fatura_tarihi','fatura_basim_tarihi','fiili_sevk_tarihi');   
</script> 
<div id="deneme"></div>
 <div id='containerHolder'>
       <div id='container' style='background: #fff; '  > 
                <h2 class='me'>
                   ...
                   &raquo;
                   <a class='active' href='#'>İrsaliyeli Fatura Ekle</a>
                </h2>
                     ...
                     <form id="form" method="post" class='jNice'>                 
                       ...
                       <div class='kullanici_ekle_satir'>
                            <div class="satir_bol">
                             ...
                             <div class="satir_bol"> 
                               <div class='kullanici_ekle_sag'  style=" padding-top: 3px;" > Fatura Saati :  </div>
                               <input style="width: 230px;" value="<?php echo (Date("H") + 1) .":". Date("i:s");  ?>"  id="fatura_basim_tarihi" name="fatura_basim_tarihi" placeholder="Fatura Düzenleme Saati " />                        
                              </div>
